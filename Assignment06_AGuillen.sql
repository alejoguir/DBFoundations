...
-- 2023-08-15,AGuillen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_AGuillen')
	 Begin 
	  Alter Database [Assignment06DB_AGuillen] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_AGuillen;
	 End
	Create Database Assignment06DB_AGuillen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_AGuillen;
...
as
	select top 1000000
	c.CategoryID, c.CategoryName, p.ProductID, p.ProductName, p.UnitPrice,i.InventoryID,i.InventoryDate,i.Count,
	e.EmployeeID,e.EmployeeFirstName+' '+e.EmployeeLastName as [EmployeeName],m.EmployeeFirstName+' '+m.EmployeeLastName as [Manager]
